...
def model_performance(file_path):
    ...
    plt.savefig('model_performance_output/accuracy.png')
    ...
    plt.savefig('model_performance_output/confusion_matrix.png')
    ...
    plt.savefig('model_performance_output/combined_roc.png')
    ...
    plt.savefig('model_performance_output/precision_recall.png')
    ...
    plt.ylabel('F1')
    plt.title('Model F1')
    plt.savefig('model_performance_output/f1.png')
