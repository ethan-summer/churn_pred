...
def random_forest_pred_and_encrypt(file_path,test_path,key):
    ...
    test_data = pd.read_csv(test_path, engine="python", encoding="gbk")
    ...
    new_file_path = test_path.split(".")[0] + "_encrypt.csv"
